...
const Icons = () => {
  return (
    <div className='grid grid-cols-2 gap-6 gap-x-2 md:gap-x-6 lg:grid-cols-4 container'>
      <div className='flex flex-col justify-center gap-4 bg-base-300 px-4 py-8 md:px-12 rounded-xl'>
